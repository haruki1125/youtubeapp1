...
class TrendViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,DoneLoadTrendProtocol,YTPlayerViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        searchAndLoad.getTrend(urlString: "https://www.googleapis.com/youtube/v3/videos?part=snippet,statistics&regionCode=JP&chart=mostPopular&key=AIzaSyAu21Dq7wQvdTcr8oUlaXnmJvRotEGX7E4&maxResults=50")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let likeCountLabel = cell.contentView.viewWithTag(4) as! UILabel
        likeCountLabel.text = trendModelArray[indexPath.row].likeCount
        
        
        let dislikeCountLabel = cell.contentView.viewWithTag(4) as! UILabel
    ...
    @IBAction func shoeTagAlert(_ sender: Any) {
